...
if AGENTS_AVAILABLE and st.session_state.api_key_valid:
...
with st.sidebar:
    ...
    if api_key_input != st.session_state.api_key or not st.session_state.api_key_checked:
        ...
        if st.session_state.api_key_valid:
            ...
            # Initialize agents with valid API key
            if AGENTS_AVAILABLE and "agents" not in st.session_state:
                st.session_state.agents = {
                    "analyst": DataAnalyst(),
                    "scientist": DataScientist(),
                    "visualizer": DataVisualizationAnalyst(),
...
if not GENAI_AVAILABLE:
    ...
    st.warning("Please enter a valid Gemini API key to use AI functionalities including chat.")
    ...
    if not AGENTS_AVAILABLE:
        ...
        if st.button("Submit Query", type="primary"):
            if not user_query:
                ...
                st.error("Please enter a valid Gemini API key to use the AI agents.")
            else:
